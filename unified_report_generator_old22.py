...
## line_items (array)
- Each item is a unique company the candidate worked for. Extract all the companies listed at CV. All companies that candidate worked must be present on the report.
